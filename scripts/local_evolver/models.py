...
class EfficientFrontier:
    ...
    max_sharpe_portfolio: FrontierPoint | None = None
    min_vol_portfolio: FrontierPoint | None = None
...
class TransactionCostConfig:
    """交易成本配置。A股ETF盘中买卖有价差，货币基金成本约等于零。"""
...
class EvolverConfig:
    ...
    walk_forward_param_sets: int = 200
    ...
    parameter_bounds: StrategyParameterBounds = field(
        default_factory=StrategyParameterBounds
    )
...
class StrategyReportData:
    ...
    recommended_params: StrategyParameterSet = field(
        default_factory=StrategyParameterSet
    )
    # Extended fields for enhanced report schema
